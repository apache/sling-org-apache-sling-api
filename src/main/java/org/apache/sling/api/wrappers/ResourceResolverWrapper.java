...
public class ResourceResolverWrapper implements ResourceResolver {
    ...
    public Iterable<Resource> getChildren(@NotNull final Resource parent) {
        ...
        return new Iterable<Resource>() {
            ...
            public Iterator<Resource> iterator() {
                return new ResourceIteratorWrapper(
                        resourceResolverWrapper, wrapped.getChildren(parent).iterator());
            }
        };
    }
    ...
    @NotNull
    @Override
    public Resource create(@NotNull Resource parent, @NotNull String name, Map<String, Object> properties)
